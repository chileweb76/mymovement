...
export default async function EditFoodPage({ params }) {
  ...
  try {
    ...
    entry = await col.findOne({ _id: objectId, userId: user._id, topic: "food" });
  } catch (error) {
  ...
  return (
    <div className="h-full flex flex-col flex-1 bg-gradient-to-br from-orange-100 to-orange-300">
